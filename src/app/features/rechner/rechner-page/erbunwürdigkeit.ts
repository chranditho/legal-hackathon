    ...
    <section>
      ...
      <div class="persons-container">
        <div class="persons-list">
          <div class="person-box" *ngFor="let person of personenListe; let i = index">
            ...
            <div class="person-exclusion-options">
                <p>      
                <mat-checkbox [(ngModel)]="person['Erbwürdig']" name="erbwuerdig">Erbwürdig</mat-checkbox>
                </p>
...
export class ErbunwürdigComponent {
