...
@Component({
  ...
  template: `
    <div
      *ngIf="showBanner"
      class="fixed bottom-0 w-full bg-gray-900 text-white px-6 py-4 flex justify-between items-center shadow-lg z-50">
      <span>
        We use cookies to enhance your experience. By using this site, you agree
